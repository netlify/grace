grace [![Build Status](https://secure.travis-ci.org/netlify/grace.png)](https://travis-ci.org/netlify/grace)
=====
...
https://github.com/netlify/grace/blob/master/gracedemo/demo.go

1. Install the demo application

        go get github.com/netlify/grace/gracedemo
...
https://godoc.org/github.com/netlify/grace/gracehttp

`net.Listener` graceful termination and restart:
https://godoc.org/github.com/netlify/grace/gracenet
